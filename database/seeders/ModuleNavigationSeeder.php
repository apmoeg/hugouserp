    ...
    protected function getNavigationStructure($modules): array
    {
        return [
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'route_name' => 'app.inventory.products.index',
                        'icon' => '📦',
                        'required_permissions' => ['inventory.products.view'],
                        'is_active' => true,
                        'sort_order' => 10,
                    ...
                    [
                        ...
                        'route_name' => 'app.inventory.categories.index',
                        'icon' => '📂',
                        'required_permissions' => ['inventory.products.view'],
                        'is_active' => true,
                        'sort_order' => 20,
                    ...
                    [
                        ...
                        'route_name' => 'app.inventory.units.index',
                        'icon' => '📏',
                        'required_permissions' => ['inventory.products.view'],
                        'is_active' => true,
                        'sort_order' => 30,
                    ...
                    [
                        ...
                        'route_name' => 'app.inventory.stock-alerts',
                        'icon' => '⚠️',
                    ...
                    [
                        ...
                        'route_name' => 'app.inventory.vehicle-models',
                        'icon' => '🚗',
                    ...
                    [
                        ...
                        'route_name' => 'app.inventory.barcodes',
                        'icon' => '🏷️',
                        'required_permissions' => ['inventory.products.view'],
                        'is_active' => true,
                        'sort_order' => 60,
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'route_name' => 'app.manufacturing.boms.index',
                        'icon' => '📋',
                        'required_permissions' => ['manufacturing.view'],
                        'is_active' => true,
                        'sort_order' => 10,
                    ...
                    [
                        ...
                        'route_name' => 'app.manufacturing.orders.index',
                        'icon' => '🏭',
                        'required_permissions' => ['manufacturing.view'],
                        'is_active' => true,
                        'sort_order' => 20,
                    ...
                    [
                        ...
                        'route_name' => 'app.manufacturing.work-centers.index',
                        'icon' => '⚙️',
                        'required_permissions' => ['manufacturing.view'],
                        'is_active' => true,
                        'sort_order' => 30,
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'route_name' => 'app.sales.returns.index',
                        'icon' => '↩️',
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'route_name' => 'app.purchases.index',
                        'icon' => '📋',
                        'required_permissions' => ['purchases.view'],
                        'is_active' => true,
                        'sort_order' => 10,
                    ...
                    [
                        ...
                        'route_name' => 'app.purchases.returns.index',
                        'icon' => '↩️',
            ...
            [
                ...
                'route_name' => 'app.warehouse.index',
                'icon' => '🏭',
            ...
            [
                ...
                'route_name' => 'app.accounting.index',
                'icon' => '🧮',
            ...
            [
                ...
                'route_name' => 'app.hrm.employees.index',
                'icon' => '👔',
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'route_name' => 'app.rental.units.index',
                        'icon' => '🏠',
                        'required_permissions' => ['rental.units.view'],
                        'is_active' => true,
                        'sort_order' => 10,
                    ...
                    [
                        ...
                        'route_name' => 'app.rental.properties.index',
                        'icon' => '🏢',
                    ...
                    [
                        ...
                        'route_name' => 'app.rental.tenants.index',
                        'icon' => '👥',
                        'required_permissions' => ['rentals.view'],
                        'is_active' => true,
                        'sort_order' => 30,
                    ...
                    [
                        ...
                        'nav_label' => 'Contracts',
                        'nav_label_ar' => 'العقارات',
                        'route_name' => 'app.rental.contracts.index',
                        'icon' => '📄',
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            [
                                ...
                                'route_name' => 'admin.currencies.index',
                                'icon' => '💰',
                                'required_permissions' => ['settings.view'],
                                'is_active' => true,
                                'sort_order' => 40,
                            ...
                            [
                                ...
                                'route_name' => 'admin.currency-rates.index',
                                'icon' => '💱',
                                'required_permissions' => ['settings.view'],
                                'is_active' => true,
                                'sort_order' => 50,
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'route_name' => 'admin.reports.pos',
                        'icon' => '📈',
                        'required_permissions' => ['pos.view-reports'],
                        'is_active' => true,
                        'sort_order' => 20,
                    ],
                    [
                        ...
                        'route_name' => 'admin.reports.inventory',
                        'icon' => '📦',
                        'required_permissions' => ['inventory.view-reports'],
                        'is_active' => true,
                        'sort_order' => 30,
                    ],
                    [
                        ...
                        'route_name' => 'app.sales.analytics',
                        'icon' => '📊',
                        'required_permissions' => ['sales.view-reports'],
                        'is_active' => true,
                        'sort_order' => 40,
                    ],
                    [
                        ...
                        'route_name' => 'admin.stores.orders',
                        'icon' => '🏪',
                        'required_permissions' => ['stores.view'],
                        'is_active' => true,
                        'sort_order' => 50,
                    ],
                    [
                    ...
                    [
                        ...
                        'route_name' => 'admin.reports.scheduled',
                        'icon' => '📅',
                        'required_permissions' => ['reports.schedule'],
                        'is_active' => true,
                        'sort_order' => 70,
                    ],
                ],
